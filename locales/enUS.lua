...
L["settings.general.reset"] = "Reset database"

L["settings.reset.all"] = "Reset all nodes"
L["settings.reset.mining"] = "Reset mining"
L["settings.reset.herbalism"] = "Reset herbalism"
L["settings.reset.fish"] = "Reset fish"
L["settings.reset.treasure"] = "Reset treasure"

L["settings.map"] = "Map settings"
L["settings.map.show"] = "Show icon on map"
L["settings.map.loot"] = "Show loot on node tooltip"
L["settings.map.size"] = "Icon size"
L["settings.map.opacity"] = "Icon opacity"
L["settings.map.neighbors"] = "Show icons on neighboring zones *"
L["settings.map.continent"] = "Show icons on continent map *"

L["settings.minimap"] = "Minimap settings"
L["settings.minimap.show"] = "Show icon on map"
L["settings.minimap.loot"] = "Show loot on node tooltip"
L["settings.minimap.edge"] = "Keep nodes on minimap edge *"
L["settings.minimap.neighbors"] = "Show icons on neighboring zones *"
...
L["settings.minimap.shift_click"] = "Shift + Left Click"
L["settings.minimap.shift_click_text"] = "Toggle"
